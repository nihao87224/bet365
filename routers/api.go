...
import (
	...
	"bet365/weChat/http/middleware/cors"
	validatorFactory "bet365/weChat/http/validator/core/factory"
	"bet365/weChat/utils/gin_release"
...
func InitApiRouter() *gin.Engine {
	...
	router.GET("/index", func(context *gin.Context) {
		context.String(http.StatusOK, "an index page！")
	})
